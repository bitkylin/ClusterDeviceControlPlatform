...
public class ClientChannelInitializer extends ChannelInitializer<NioSocketChannel> {
    ...
    @Autowired
    public ClientChannelInitializer(FrameRecognitionInBoundHandler frameRecognitionInBoundHandler, ParsedMessageInBoundHandler parsedMessageInBoundHandler, MsgRecognitionOutBoundHandler recognitionOutBoundHandler, ConfigHandler configHandler) {
